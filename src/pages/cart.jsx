        ...
        <div className="lg:absolute lg:left-[35%] lg:top-[12%] lg:w-[60%]">
          ...
          {!empty && (
            <div>
              ...
              >
                <button className="text-white rounded-[20px] bg-[#4e4e86] font-bold mt-[2rem] py-[0.5rem] px-[1rem]">
                  Check Out
                </button>
              </div>
            </div>
          )}
          <p className="text-white lg:hidden text-center bg-[#4e4e86] fixed text-[10px] w-[4%] left-[93%] top-[3%] z-20 rounded-full">
            {saved.length}
          </p>
        </div>
      ) : (
