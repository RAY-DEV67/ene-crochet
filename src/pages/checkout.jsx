        ...
        <div>
         <p className="text-center pt-[1rem] text-2xl">Check-Out</p>
          ...
          <div className="my-[2rem] mx-[1rem]">
            ...
            <div className="border-[#4e4e86] border my-[1rem] p-[1rem] text-left">
              ...
              <button onClick={upload}  className="text-white rounded-[20px] bg-[#4e4e86] font-bold w-[30%] mt-[2rem] py-[0.5rem] px-[1rem]">Upload</button>
            </div>
          </div>
...
<form ref={form} onSubmit={sendEmail} className="w-[90%] border-[#4e4e86] border my-[1rem] flex flex-col px-[1rem] pb-[1rem]">
      <label className="text-left mt-[0.5rem]">Name</label>
      <input onChange={(e) => {
setname(e.target.value)
      }} type="text" name="user_name" className="border-[#4e4e86] border py-[0.5rem] rounded-[10px] px-[1rem]" />
     {errors.name && <p className="error">{errors.name}</p>}
      <label className="text-left mt-[0.5rem]">Street Address</label>
      <input onChange={(e) => {
setstreet(e.target.value)
      }}  type="text" name="Street" className="border-[#4e4e86] border py-[0.5rem] rounded-[10px] px-[1rem]"/>
      ...
      onChange={(e) => {
        settown(e.target.value)
                ...
                className="py-[0.5rem] rounded-[10px] px-[1rem] border-[#4e4e86] border"
                type="text"
                name="Town"
              />
      ...
      onChange={(e) => {
        setstate(e.target.value)
                ...
                className="py-[0.5rem] rounded-[10px] px-[1rem] border border-[#4e4e86]"
                type="text"
                name="State"
              />
      ...
      <textarea name="message" className="border-[#4e4e86] border rounded-[10px]" />
...
<label className="text-left mt-[0.5rem] opacity-0">Product</label>
                    ...
                    />
    <div>
    <input type="submit" value="Place Order" className="text-white rounded-[20px] bg-[#4e4e86] font-bold w-[50%] mt-[2rem] py-[0.5rem] px-[1rem]" />
