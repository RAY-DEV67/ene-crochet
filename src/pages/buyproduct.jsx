    ...
    <div className="productfont lg:absolute lg:left-[35%] lg:top-[12%] lg:w-[60%]">
      ...
      <div className="mx-[1rem] text-left">
       ...
       {buyProduct?.description ?  <div className="mb-[1rem]">
        ...
        <div className="py-[0.5rem] px-[1rem] rounded-sm mt-[1rem] w-[130px] mb-[0.5rem] bg-[#4e4e86]" onClick={() => {
                !user
                  ? navigate("/Profile")
                  : hasProductBeenSaved
                  ? removeCart()
          ...
          {loadingCart ? (
           ...
           <p className="text-white text-center text-sm w-[100%]">{hasProductBeenSaved ? "Added To Cart!!" : "Add To Cart "}</p>
          )}
        </div>
             </div>
