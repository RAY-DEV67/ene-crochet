      ...
      {user ? (
        <div className="flex flex-col items-center">
          <div className="flex flex-col items-center border rounded-[10px]  mt-[2rem] w-[80%] ">
            <div className="flex flex-col items-center topnav mb-[1rem] py-[1rem] rounded-[10px] bg-[#4e4e86] text-white font-bold w-[100%]">
            ...
            <div className="flex flex-col items-center mb-[2rem] w-[100%]">
              <div
                ...
                className="rounded-[20px] bg-[#4e4e86] text-white font-bold mb-[0.5rem] mt-[rem] w-[50%] p-[0.5rem]"
              >
                <p className="text-center">View Cart</p>
              </div>
              <button
                onClick={SignUserOut}
                className="rounded-[20px] w-[50%] bg-[#4e4e86] text-white font-bold mb-[0.5rem] p-[0.5rem]"
              >
                Sign Out
              </button>
            </div>
        ...
        <div className="overflow-hidden">
          <div className="flex flex-col items-center justify-center h-[70vh]">
            <div className="border login-page w-[90%] pb-[1rem] rounded-[10px]">
              <div className="flex flex-col items-center justify-center py-[1rem] bg-[#4e4e86] text-white font-bold rounded-t-[10px]">
                {/* <img src={logo} alt="Logo" className="w-[25vw] " /> */}
                <p className="mt-[0.5rem]">AESTHETIC WEARS FOR EVERY BEAUT❤</p>
              </div>
              ...
              <div className="flex flex-col items-center">
                <div
                  ...
                  className="border font-bold sign-in-google rounded-[20px] bg-[#4e4e86] text-white cursor-pointer w-[60%] py-[0.3rem] mt-[2rem] flex justify-center"
                >
                  <svg
                    viewBox="-0.5 0 48 48"
                    version="1.1"
