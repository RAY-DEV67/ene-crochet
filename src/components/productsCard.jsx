 ...
 export function ProductsCard(props) {
    ...
    return (
      <div className="flex flex-col items-center">
        ...
        <div className="border-y border-[#4e4e86] w-[80vw] lg:w-[100%] lg:h-[190px] flex rounded-[10px]">
          <div className="w-[40%]">
            <img
              src={post.images}
              alt="Product"
          ...
          <div className="ml-[1rem]">
            <div>
              <div className="flex justify-between w-[40vw]">
                <h1 className="text-[#4e4e86] font-bold mt-[0.5rem] text-left">{formatCur(post.price1 , 'en-NG' , "NGN")}</h1>
              </div>
